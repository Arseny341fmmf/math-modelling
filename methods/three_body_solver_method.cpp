...
using mm::ThreeBodySolver;

namespace mm {

// Вспомогательная шаблонная функция для обработки входных данных
...
/**
 * @brief Основная функция-обработчик HTTP POST /ThreeBodySolver.
 */
